...
// prietenii sunt prieteni pe categoria friends
person.friends.larry = larry;
person.friends.steven = steven;
person.friends.andrea = andra;

//  reverse obiectul friends are prietenii
...
console.warn(
  `Folosind obiectul Andra afiseaza numarul total de caracteere al numelui complet al lui Person`,
);
